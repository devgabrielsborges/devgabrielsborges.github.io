        ...
        <div class="header-content">
          ...
          <div class="nav-icons">
            ...
            <a href="https://linkedin.com/in/devgabrielsborges" target="_blank" class="nav-icon-link">
              ...
              >
                <path
                  d="m5.839 4.5c0-.864.7-1.5 1.561-1.5s1.54.636 1.54 1.5c0 .864-.679 1.5-1.54 1.5s-1.561-.636-1.561-1.5zm.184 19.5v-15h2.962v15zm4.455 0v-15h2.962v2.310c.739-1.472 2.564-2.499 4.28-2.499 3.637 0 5.542 3.052 5.542 7.019v8.17zm9.213-8.372c0-2.063-.826-3.077-2.415-3.077-1.543 0-2.529 1.02-2.529 3.077v8.372h-2.962v-8.372z"
                ></path>
              </svg>
            </a>
            <!-- Email Icon -->
            <a href="mailto:gabriel.sborges@upe.br" class="nav-icon-link">
              <svg
                class="nav-icon"
                viewBox="0 0 24 24"
                fill="none"
      ...
      <section class="featured-projects-section">
        <div class="container">
          ...
          <div class="projects-grid">
            ...
            <div class="project-card">
              <div class="project-header">
                <h3>Sistema de Teleconsultas - IA</h3>
                <div class="project-links">
                  <a href="#" class="project-link private">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p class="project-description">
                Sistema de IA para pré-diagnóstico médico em teleconsultas. Desenvolvimento de algoritmos 
                de machine learning para auxiliar profissionais de saúde na tomada de decisões.
              </p>
              <div class="project-tech">
                <span class="tech-tag">Python</span>
            ...
            <div class="project-card">
              <div class="project-header">
                <h3>Aplicações GTK/C</h3>
                <div class="project-links">
                  <a href="https://github.com/devgabrielsborges" target="_blank" class="project-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                    </svg>
                  </a>
              ...
              <p class="project-description">
                Desenvolvimento de aplicações desktop multiplataforma usando GTK e linguagem C. 
                Consultoria em projetos com GCC, CMake e otimização de performance.
              </p>
              <div class="project-tech">
                <span class="tech-tag">C</span>
                <span class="tech-tag">GTK</span>
          ...
          <div class="projects-grid">
            <div class="project-card">
              <div class="project-header">
                <h3>Autorriculum</h3>
                <div class="project-links">
                  <a href="https://github.com/devgabrielsborges/autorriculum" target="_blank" class="project-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
              ...
              <p class="project-description">
                Projeto de desenvolvimento em código aberto. LLM based application for creating CVs based on your GitHub and LinkedIn profile
              </p>
              <div class="project-tech">
            ...
            <div class="project-card">
              <div class="project-header">
                <h3>Mcp Fl</h3>
                <div class="project-links">
                  <a href="https://github.com/devgabrielsborges/mcp-fl" target="_blank" class="project-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.30.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                    </svg>
                  </a>
              ...
              <p class="project-description">
                Projeto de desenvolvimento em código aberto. Model Context Protocol Integration for Scalable Federated Learning
              </p>
              <div class="project-tech">
            ...
            <div class="project-card">
              <div class="project-header">
                <h3>Replica</h3>
                <div class="project-links">
                  <a href="https://github.com/devgabrielsborges/replica" target="_blank" class="project-link">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.30.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                    </svg>
                  </a>
              ...
              <p class="project-description">
                Projeto de desenvolvimento em código aberto. Replica is a command-line utility for copying default prompt and instructions templates, designed to streamline the setup of agentic applications.
              </p>
              <div class="project-tech">
                <span class="tech-tag">C</span>
                <span class="tech-tag">CMake</span>
